# Project 2 - *Codepath Twitter Clone Part Two*

**Codepath Twitter Clone Part Two** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
# Project 2 - *Codepath Twitter Clone Part One*

**Codepath Twitter Clone Part One** is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://i.imgur.com/KPlRapR.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
